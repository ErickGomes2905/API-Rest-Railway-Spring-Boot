...
public class AutorController {
    ...
    @GetMapping
    @Operation(summary = "Autores", description = "Recupera uma lista com todos os autores cadastrados")
    @ApiResponses(value = { 
    ...
    @GetMapping("/{id}")
    @Operation(summary = "Autor pelo ID", description = "Recupera um autor específico baseado pelo ID")
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Operação bem sucedida"),
    ...
    @DeleteMapping("/{id}")
    @Operation(summary = "Exclui um autor", description = "Exclui um autor existente baseado no seu ID")
    @ApiResponses(value = { 
